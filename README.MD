...
# Debian
   ...
   **Restart Mosquitto**
   ...
   ```
   Now we're ready to setup our client, let's set it up. Open the [client](*Insert file link here*) and edit `MQTT_TOPIC` and `PIN` according to your needs and your gBridge topic's name.
   **Start the client**
